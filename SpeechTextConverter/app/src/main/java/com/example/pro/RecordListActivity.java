...
//        actionBar.setTitle("Record List");
        ...
        Cursor cursor = SpeechToText.mSQLiteHelper.getData("SELECT * FROM RECORD");
        mList.clear();
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i == 0){
                            //update
                            Cursor c = SpeechToText.mSQLiteHelper.getData("SELECT id FROM RECORD");
    ...
    private void showDialogDelete(final int idRecord) {
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                try {
                    SpeechToText.mSQLiteHelper.deleteData(idRecord);
    ...
    public void back() {
        Intent intent2 = new Intent(this, SpeechToText.class);
